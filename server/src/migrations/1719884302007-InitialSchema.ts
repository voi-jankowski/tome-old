...
export class InitialSchema1719884302007 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "item_attributes" ("id" SERIAL NOT NULL, "value" character varying NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "itemId" integer, "attributeId" integer, CONSTRAINT "PK_1f04d0cef03934743b1d54e4ae8" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
      `CREATE TABLE "attributes" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "type" character varying NOT NULL, "isDefault" boolean NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "categoryId" integer, CONSTRAINT "PK_32216e2e61830211d3a5d7fa72c" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "item_attributes" ADD CONSTRAINT "FK_d2f52db45e62d7dec5e7a9de233" FOREIGN KEY ("itemId") REFERENCES "items"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`
    );
    await queryRunner.query(
      `ALTER TABLE "item_attributes" ADD CONSTRAINT "FK_19bef966888dbf33b1ce5d63289" FOREIGN KEY ("attributeId") REFERENCES "attributes"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`
    );
    await queryRunner.query(
      `ALTER TABLE "attributes" ADD CONSTRAINT "FK_bfb466d453dc3a8265c45b79962" FOREIGN KEY ("categoryId") REFERENCES "categories"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(`
            WITH char_cat AS (
                SELECT id FROM categories WHERE name = 'Character'
            )
    ...
    await queryRunner.query(`
            WITH place_cat AS (
                SELECT id FROM categories WHERE name = 'Place'
            )
            INSERT INTO "attributes" ("name", "type", "isDefault", "created_at", "updated_at", "categoryId") VALUES
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "attributes" DROP CONSTRAINT "FK_bfb466d453dc3a8265c45b79962"`
    );
    await queryRunner.query(
      `ALTER TABLE "item_attributes" DROP CONSTRAINT "FK_19bef966888dbf33b1ce5d63289"`
    );
    await queryRunner.query(
